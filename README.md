...
Инофрмация о нахождении предмета в корзине хранится в виде порядкого номера добавления этого продукта в коризну (если не
добавлен, то номер равен 0).

Основные использующиеся методы:

- `addToBasket` - добавляет товар в корзину.
- `toggleToBasket` - меняет состояние товара в корзине (добавляет если не в корзине, удаляет из корзины если в корзине).
